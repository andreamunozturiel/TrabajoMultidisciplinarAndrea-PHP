        ...
        <div class="col-12 p-0" id="navColor">
            ...
            <nav class="navbar navbar-expand-lg navbar-light" id="navMovil">
                ...
                <a class="navbar-brand d-lg-none" href="#">
                    ...
                    <h1 class="font-jack" id="nombreMovil">l'occhio del fotografo</h1>
                </a>
                <!-- Toggler Button -->
                ...
                <div class="col s12">
                    <div class="carousel center-align">
                        <div class="carousel-item">
                            <img src="images/Bodas/Fotografías Jaime.JPG" alt="">
                        </div>

                        <div class="carousel-item">
                            <img src="images/Bodas/Fotografías Jaime_1.JPG" alt="">
                        </div>

                        <div class="carousel-item">
                            <img src="images/Bodas/Fotografías Jaime_2.JPG" alt="">
                        </div>

                        <div class="carousel-item">
                            <img src="images/Bodas/Fotografías Jaime_3.JPG" alt="">
                        </div>

                        <div class="carousel-item">
                            <img src="images/Bodas/Fotografías Jaime_4.JPG" alt="">
                        </div>
                    </div>
                </div>
            </div>
